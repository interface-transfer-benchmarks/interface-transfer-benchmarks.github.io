...
| PA-003 | solidification | 2D disk | exact-similarity | curvature, isotropy, and area conservation |
| PA-004 | solidification | 3D sphere | exact-similarity | surface integration, isotropy, and volume conservation |
| PA-005 | boiling, evaporation | 1D planar | exact-similarity | Stefan flow and phase-volume expansion |
| PA-006 | boiling, evaporation | 3D sphere | exact-similarity | spherical Stefan flow and large density ratio |
...
| PA-010 | dissolution | 3D sphere | semi-analytical-ode | coupled radius-concentration ODE and vanishing radius |
| PA-011 | solidification | 1D planar | exact-similarity | coupled heat and solute balance at the interface |
| PA-012 | evaporation | 3D sphere | quasi-steady-analytical | quasi-steady gas-phase transport and shrinking droplet |
| PA-013 | condensation | 2D vertical-plate | analytical-boundary-layer | thin condensate film and interfacial shear |
| PC-001 | solidification | 1D planar | exact-solution | prescribed moving Dirichlet boundary |
| PC-002 | dissolution | 2D/axisymmetric circle-sphere | exact-kinematic | prescribed mass-transfer shrinkage |
| PE-001 | melting | 2D rectangular-cavity | experimental | natural convection coupled to a melting front |
| PN-001 | boiling, evaporation | 2D horizontal-wall | numerical-plus-correlation | vapor-film instability and bubble release |
