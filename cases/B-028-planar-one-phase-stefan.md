...
# B-028 - Planar one-phase Stefan problem
...
The file `data/B-028/reference.csv` tabulates $s(t)$ and $T(x,t)$ for selected
times and normalized positions $\chi=x/s(t)$.

![B-028 reference interface position](../figures/B-028-reference.svg)
