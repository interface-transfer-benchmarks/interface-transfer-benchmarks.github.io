...
The file `data/B-030/reference.csv` tabulates $R(t)$ and $T(r,t)$ for selected
times and normalized radii.

![B-030 Frank sphere reference temperature profile](../figures/B-030-reference.svg)
