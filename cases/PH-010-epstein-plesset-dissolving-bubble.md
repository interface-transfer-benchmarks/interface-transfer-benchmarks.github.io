...
the moving-radius companion of PH-009, which freezes the interface and tests
...
The file `data/PH-010/reference.csv` tabulates $R(t)$ from a high-order
...
![PH-010 Epstein-Plesset reference](../figures/PH-010-reference.svg)
