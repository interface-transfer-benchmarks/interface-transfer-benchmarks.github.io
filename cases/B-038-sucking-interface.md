...
# B-038 - Sucking interface problem
...
The file `data/B-038/reference.csv` tabulates $\delta(t)$, $u_l(t)$, and
$T_l(x,t)$ for selected times and positions.

![B-038 sucking-interface reference](../figures/B-038-reference.svg)
