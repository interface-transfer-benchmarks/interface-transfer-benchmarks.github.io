...
reference_note: exact radial similarity solution
numerical_challenge: curvature, isotropy, and area conservation
...
The file `data/B-029/reference.csv` tabulates $R(t)$ and $T(r,t)$ for selected
times and normalized radii.

![B-029 Frank disk reference temperature profile](../figures/B-029-reference.svg)
