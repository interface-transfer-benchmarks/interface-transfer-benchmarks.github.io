...
reference_data:
  - data/PH-005/reference.csv
figures:
  - figures/PH-005-reference.svg
...
The file `data/PH-005/reference.csv` tabulates $\delta(t)$, $u_l(t)$, and
...
```bash
python3 scripts/plot_reference_figures.py PH-005
```
